    ...
    const renderView = () => {
        switch (activeView) {
            case 'marketplace':
                ...
                return <BuyerDashboard role={UserRole.WHOLESALER} onSelectProduct={(id) => setMarketplaceView({view: 'detail', productId: id})}/>;
            case 'purchases':
        ...
        <DashboardLayout navItems={navItems} activeView={activeView} setActiveView={setActiveView}>
            <div className="flex justify-between items-center mb-6">
                 <h2 className="text-3xl font-bold text-primary">
                    {activeView === 'dashboard' ? t('wholesalerControlPanel') : t(navItems.find(i => i.view === activeView)?.label as any)}
                </h2>
                <div>
