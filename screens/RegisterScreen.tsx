      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white p-8 rounded-lg shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input name="phoneNumber" placeholder={t('phone')} value={formData.phoneNumber} onChange={handleChange} required className="p-2 border rounded" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             ...
             <div className="flex items-center space-x-2">
                <input type="checkbox" id="enable2FA" name="enable2FA" checked={formData.enable2FA} onChange={handleChange} className="h-4 w-4 text-primary focus:ring-accent border-gray-300 rounded"/>
                <label htmlFor="enable2FA" className="text-sm text-gray-600">{t('enable2FA')}</label>
            </div>
