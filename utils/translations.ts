...
export const translations = {
  en: {
    ...
    createYourAccount: 'Create Your {{storeType}} Account',
    fullName: 'Full Name',
    ...
    trialMessage: 'You are on a 30-day free plan. You have {{days}} days remaining.',
  ...
  fr: {
    ...
    createAStore: 'Créer une boutique',
    ...
    createYourAccount: 'Créez votre compte de {{storeType}}',
    ...
    trialMessage: 'Vous êtes sur un plan gratuit de 30 jours. Il vous reste {{days}} jours.',
  ...
  ar: {
    ...
    createYourAccount: 'أنشئ حساب {{storeType}} الخاص بك',
    ...
    trialMessage: 'أنت مشترك في الخطة المجانية لمدة 30 يومًا. لديك {{days}} أيام متبقية.',
    trialExpired: 'انتهت الفترة التجريبية المجانية!',
    ...
    wholesalePrice: 'سعر الجملة (د.م.)',
    retailPrice: 'سعر التجزئة (د.م.)',
    ...
    enterDeliveryPricePrompt: 'يرجى إدخال سعر التوصيل (د.م.):',
